...
$string['redirectroles_desc'] = 'حدد الأدوار التي سيتم إعادة توجيهها. سيتم تحويل المستخدمين الذين لديهم الأدوار المحددة وصلاحية local/smartprofile:view فقط. في حال عدم تحديد أي دور، يتم تعطيل إعادة التوجيه.';
...
$string['pro_promo_desc'] = 'هل تبحث عن بطاقات Apple Wallet الرقمية، وشهادات Open Badges 3.0، وبناء السير الذاتية PDF، وتوصيات أعضاء هيئة التدريس؟ <a href="https://services.smartlearn.education/services/plugins/local_smartprofile" target="_blank" class="btn btn-sm btn-primary ms-2">استكشف مزايا Pro ↗</a>';
$string['pro_menu_item'] = 'SmartProfile Pro';
$string['pro_page_title'] = 'النسخة الاحترافية والمؤسسية SmartProfile Pro';
$string['pro_badge'] = 'النسخة الاحترافية والمؤسسية';
$string['pro_hero_title'] = 'ارتقِ بمنصة موودل بهوية رقمية أكاديمية متكاملة';
$string['pro_hero_desc'] = 'فعّل بطاقات Apple Wallet الرقمية، وشهادات Open Badges 3.0، وبناء السير الذاتية الأكاديمية PDF، وتوصيات أعضاء هيئة التدريس، والتخصيص المؤسسي الشامل.';
$string['pro_get_btn'] = 'احصل على SmartProfile Pro ↗';
$string['pro_feat_wallet_title'] = 'بطاقات Apple Wallet الرقمية (.pkpass)';
$string['pro_feat_wallet_desc'] = 'تمكين المتعلمين من تحميل بطاقات الهوية الأكاديمية الرقمية لمحفظة أبل مع رمز QR للتحقق الفوري.';
$string['pro_feat_cv_title'] = 'بناء وتصدير السيرة الذاتية PDF بضغطة زر';
$string['pro_feat_cv_desc'] = 'توليد سيرة ذاتية أكاديمية احترافية فورية مزودة برمز استجابة سريعة QR يربط ببوابة التحقق العامة.';
$string['pro_feat_endorse_title'] = 'محرك تزكيات وتوصيات أعضاء هيئة التدريس';
$string['pro_feat_endorse_desc'] = 'يتيح للمعلمين كتابة توصيات معتمدة وتقييم مهارات الطلاب وعرضها في الملف الشخصي والسيرة الذاتية.';
$string['pro_feat_obv3_title'] = 'واجهة W3C / 1EdTech Open Badges 3.0';
$string['pro_feat_obv3_desc'] = 'نقطة نهاية معتمدة لتصدير الإثباتات المشفرة المتوافقة مع معايير الأوسمة المفتوحة الإصدار الثالث JSON-LD.';
$string['pro_compare_title'] = 'مقارنة المزايا بين النسختين';
$string['pro_compare_subtitle'] = 'جدول المقارنة بين النسخة المجانية (Community) والنسخة الاحترافية (Pro).';
$string['edition_free'] = 'النسخة المجانية (Free)';
$string['edition_pro'] = 'النسخة الاحترافية (Pro)';
$string['comp_modern_profile'] = 'واجهة الملف الأكاديمي الرقمي الحديثة';
$string['comp_privacy_toggles'] = 'نظام الخصوصية ثلاثي الطبقات وإخفاء الحقول';
$string['comp_course_progress'] = 'عرض المقررات والأوسمة والتقدم الأكاديمي';
$string['comp_wallet_passes'] = 'بطاقات Apple Wallet الرقمية (.pkpass)';
$string['comp_cv_builder'] = 'منشئ السير الذاتية الأكاديمية الديناميكية PDF';
$string['comp_faculty_endorsements'] = 'توصيات وتزكيات أعضاء هيئة التدريس المعتمدة';
...
$string['pro_feat_faculty_title'] = 'العرض التكيفي لملف أعضاء هيئة التدريس والمعلمين';
$string['pro_feat_faculty_desc'] = 'نظام تكيفي ذكي يكشف تلقائياً الأساتذة والمعلمين لعرض المقررات المدرّسة، وإجمالي الطلاب، ومقاييس التخصص، وروابط الأبحاث الأكاديمية.';
$string['comp_faculty_mode'] = 'النمط التكيفي لملفات أعضاء هيئة التدريس والمعلمين';
$string['pro_feat_trophy_title'] = 'درع الأوسمة الملكي ونقاط الخبرة التراكمية';
$string['pro_feat_trophy_desc'] = 'عرض مستويات المتعلمين والأوسمة ونقاط الخبرة XP وساعات التميز الأكاديمي مع الربط المباشر ببطاقات Apple Wallet.';
$string['comp_trophy_shield'] = 'درع الأوسمة الملكي ونظام الألعاب الأكاديمي';
$string['pro_bundle_badge'] = 'عرض الحزمة المؤسسية الخاصة • وفّر أكثر';
$string['pro_bundle_title'] = 'حزمة SmartProfile Pro + محرك الأوسمة والعملات الأكاديمية';
$string['pro_bundle_desc'] = 'زوّد منصتك التعليمية بأفضل بيئة أكاديمية تفاعلية. ادمج بين SmartProfile Pro ومحرك الأوسمة والجوائز الآلي بسعر مخفض خاص بالحزمة.';
$string['pro_bundle_item_sp'] = 'SmartProfile Pro: بطاقات Apple Wallet، وشهادات Open Badges 3.0، وبناء السير الذاتية PDF، وتوصيات المعلمين.';
$string['pro_bundle_item_trophy'] = 'محرك الأوسمة: منح تلقائي للجوائز والميداليات ونقاط الخبرة مع محفظة رقمية.';
$string['pro_bundle_item_sync'] = 'مزامنة وتكامل تلقائي سلس وتلقائي بالكامل بين الإضافتين.';
$string['pro_bundle_btn'] = 'احصل على الحزمة بخصم خاص ↗';
